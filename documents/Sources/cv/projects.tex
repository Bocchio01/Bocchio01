...
\descriptionstyle{
    Selection (not exhaustive, see my website for more details) of some projects I've worked on that relate to my academic, professional, and personal interests.\\
...
\begin{cventries}
    ...
    {Mar 2023 - Jun 2023}
    {
        \begin{minipage}{0.72\textwidth}
            ...
            \end{center}
            \vspace{5pt}
            Designed and developed a personal transportation vehicle for urban sidewalks.\\
            Team project with students from four top European universities, featuring iterative feedback from RIMAC engineers. Selected as the winning team.\\
            \begin{cvitems}
                \item {Hackathon 1: Defined visions, user personas, functions, and requirements.}
                \item {Hackathon 2: Performed functional decomposition, created morphological matrix, and developed concepts.}
                \item {Hackathon 3: Completed CAD design, FEM simulations, FMEA, and cost analysis.}
            \end{cvitems}
            \vspace{4mm}
            \vspace{5pt}
        \end{minipage}
        ...
        \begin{minipage}{0.25\textwidth}
            \vspace{5pt}
            \begin{center}
                \includegraphics[height=205pt]{common/img/Rimac/3.jpg}
            \end{center}
            \vspace{5pt}
        \end{minipage}
    }
    ...
    {Jun 2023}
    {
        \begin{minipage}{\textwidth}
            ...
            \end{overpic}
            \vspace{3pt}
            Designed, optimized, and built a $63\,\mathrm{cm}$ model rocket using CAD and CFD-driven iterations.\\
            Constructed primarily from low-cost materials (cardboard \& wood) with 3D printed PLA components.\\
            Key features:\\
            \begin{cvitems}
                \item {Flight time $\approx 60\,\mathrm{s}$; maximum speed $+120\,\mathrm{m/s}$; peak acceleration $+10g$.}
                \item {Parachute-based recovery system, fully functional and reliable.}
                \item {On-board flight computer with barometric, temperature, and accelerometer sensors capable of logging flight data.}
            \end{cvitems}
            \vspace{4mm}
        \end{minipage}
    }
